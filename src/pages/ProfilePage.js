  ...
  return `
    <div class="p-6 max-w-3xl mx-auto text-white">
      ...
      <div class="flex items-center gap-4 mb-6">
        ...
        <div class="rounded-full h-20 w-20 bg-white text-black flex items-center justify-center text-3xl font-bold">${name[0].toUpperCase()}
        </div>
        ...
        <form id="form-update-profile" class="space-y-3">
          ...
          <div>
            <button id="btn-update-profile" type="submit"
              class="cursor-pointer bg-white text-black px-4 py-2 rounded">Lưu thông tin</button>
        ...
        <form id="form-change-password" class="space-y-3">
          ...
          <div>
            <button id="btn-change-password" type="submit"
              class="cursor-pointer bg-white text-black px-4 py-2 rounded">Đổi mật khẩu</button>
